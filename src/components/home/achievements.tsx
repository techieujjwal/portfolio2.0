...
// Use CSS Variables for the spotlight to avoid useTransform SSR issues
...
<Card   
ref={cardRef}  
className="relative h-full min-h-[400px] border-white/[0.05] bg-neutral-950/50 backdrop-blur-2xl overflow-hidden transition-colors hover:border-white/[0.15] [--x:0px] [--y:0px]"  
>
{/* Spotlighting Effect via CSS Variables */}
<div
...
// Inline Data URI for Noise to ensure zero external dependency & CSP safety
...
{/* Production-safe Background Noise */}  
  <div   
